...
//    private static final String APP_SECRET = "--here is your crs image space's secret--";
    ...
    /**
     * @describe 查找相似图片，有则返回,没有则返回
     * @param image
     * @return java.lang.String
     */
    public static String getSimialars(String image) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
        String simialars = getSimialars("C:\\Users\\Administrator\\Desktop\\image\\tooopen_sy_132824668481.jpg");
        System.out.println(simialars);
    }
}
