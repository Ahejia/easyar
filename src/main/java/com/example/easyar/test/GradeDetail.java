...
//    private static final String APP_SECRET = "--here is your crs image space's secret--";
     ...
     */
    public static String gradeDetail(String image)throws Exception{
        ...
        return response.body().string();//test_target_image.jpg
    }


    public static void main(String[] args) throws Exception {
        String s = gradeDetail("test_target_image.jpg");
